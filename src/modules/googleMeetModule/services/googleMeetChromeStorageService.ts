...
export class GoogleMeetChromeStorageService
   implements GoogleMeetChromeStorageInterface
{
   constructor() {}

   // ------------- get meeting data and save to chrome.storage --------------

   public getMeetingsData = async (
      title: GoogleMeetTopics[number],
   ...
   private setMeetingConfigList = (
      meetTitle: GoogleMeetTopics[number],
      currentMeetingData: MeetingsData,
   ) => {
